...
public interface TimesService {
    void createTime(EntryPositionTime entryPositionTime, String sessionId) throws ServiceException;
    void updateTime(EntryPositionTime entryPositionTime, String sessionId) throws ServiceException;
